...
export const TOOL_COMPONENTS: Record<ToolId, ComponentType> = {
  ...
  vectorforge: dynamic(() =>
    import("./vector-forge/vector-forge-tool").then((m) => m.VectorForgeTool)
  ),
  launchready: dynamic(() =>
  ...
  pathfinding: dynamic(() =>
    import("./pathfinding/pathfinding-tool").then((m) => m.PathfindingTool)
  ),
  ...
  promptworkbench: dynamic(() => import("./prompt-workbench/prompt-workbench-tool").then((m) => m.PromptWorkbenchTool)),
};
