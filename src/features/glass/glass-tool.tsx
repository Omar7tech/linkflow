...
export function GlassTool() {
  ...
  const [config, setConfig] = React.useState<GlassConfig>(
    GLASS_PRESETS[0].config,
  );
  ...
  const scene =
    sceneId === "custom" && customBg
      ? {
          id: "custom",
          name: "Custom",
          background: `url(${customBg}) center / cover`,
          fg: customFg,
        }
  ...
  const commit = () =>
    history.add(
      `Glass · blur ${config.blur}px · ${config.opacity}% ${config.tint}`,
      css,
    );
  ...
  return (
    ...
    >
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(340px,420px)]">
        {/* Preview first in the DOM so it leads on mobile; sticky on desktop so it
            stays in view while the settings below-left are being tweaked. */}
          ...
          <div className="lg:sticky lg:top-20">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Drag the card around to see how the glass reacts to what is
                  behind it.
                </CardDescription>
              </CardHeader>
                ...
                >
                  ...
                  >
                    <div className="pointer-events-none space-y-3">
                      ...
                      >
                        Glassmorphism keeps content readable while the
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {sceneId === "custom" && (
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        setCustomFg((f) => (f === "light" ? "dark" : "light"))
                      }
        ...
        <div className="min-w-0 space-y-6 lg:col-start-1 lg:row-start-1">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Includes a solid-color fallback for browsers without
                backdrop-filter.
              </CardDescription>
            </CardHeader>
            <CardContent>
