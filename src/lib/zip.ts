/**
 * Minimal ZIP writer — STORE method (no compression), enough for packaging a
 * handful of already-compressed PNGs client-side without pulling in a library.
 */
...
/** Pack entries into a ZIP blob. Names must be ASCII-safe. */
