...
const STEPS = [
  {
    title: "Pick a tool",
    text: "WhatsApp links, QR codes, share buttons, vCards, UTM URLs, passwords, hashes — thirteen focused generators, one consistent workflow.",
  },
  {
    ...
    <>
      ...
      <section className="mx-auto w-full max-w-6xl px-4 py-24" aria-labelledby="tools-heading">
        <div className="mb-10 flex flex-wrap items-end justify-between gap-6">
          <SectionHeader label="01 — The toolkit" title="Thirteen tools, one workflow" id="tools-heading" />
          <Reveal>
