...
/** TM TOOLS glyphs, in the 900×190 coordinate space of the master logo file. */
...
export const TM_GLYPHS = [
  ...
  // T
  <g key="t2" transform="translate(278 0)">
    <polygon points={T} />
  </g>,
  // Stretched O
  <path
  ...
  />,
  // L
  <path key="l" d="M680 34.13H698.8V149.6H758V166.18H680Z" />,
  // S
  <g key="s" transform="translate(-156.29 0)">
...
export const TM_VIEWBOX = "0 22 900 158";
